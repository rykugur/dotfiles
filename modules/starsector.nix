{ self, ... }:
{
  flake.nixosModules.starsector =
    { config, lib, ... }:
    {
      ...
      home-manager.users.${config.meta.ryk.username}.imports = [ self.homeModules.starsector ];
    };

  flake.homeModules.starsector =
    {
      lib,
      osConfig,
      pkgs,
    ...
    let
      ...
      magiclib = pkgs.fetchzip {
        url = "https://github.com/LazyWizard/lazylib/releases/download/3.0/LazyLib.3.0.zip";
        sha256 = "sha256-TO1jF90DRgS9cPOxFtXfff9+6Ll0S+bv2ULQ+2qsL38=";
      };
      nexerelin = pkgs.fetchzip {
        url = "https://github.com/Histidine91/Nexerelin/releases/download/v0.12.1/Nexerelin_0.12.1.zip";
        sha256 = "sha256-VaUNVsSlBXOTHpf+sjzY5Oim3ObbcsX8GEHr9K+wtcc=";
      };
      graphicslib = pkgs.lib.fetch7z {
        url = "https://bitbucket.org/DarkRevenant/graphicslib/downloads/GraphicsLib_1.12.1.7z";
