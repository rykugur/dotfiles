...
in
{
  ...
  flake.homeModules.${moduleName} =
    ...
    let
      dankCfg = config.ryk.${moduleName};
      hyprlandCfg = config.ryk.hyprland or { };
    ...
    in
    {
      ...
      programs.niri.settings = lib.mkIf (niriCfg.enable && niriCfg.bar == "dankMaterialShell") {
      ...
      wayland.windowManager.hyprland.settings =
        lib.mkIf (hyprlandCfg.enable && hyprlandCfg.bar == "dankMaterialShell")
          {
            bind =
              let
