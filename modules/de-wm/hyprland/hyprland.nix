{ inputs, self, ... }:
{
  ...
  flake.homeModules.hyprland =
    ...
    let
      hyprCfg = config.ryk.hyprland;
    in
    {
      imports = [
        ./_hyprland-options.nix
      ...
      wayland.windowManager.hyprland =
        ...
        in
        {
          ...
          plugins =
            lib.optionals useHy3 [ pkgs.hyprlandPlugins.hy3 ]
            ++ lib.optionals useHyprscrolling [ pkgs.hyprlandPlugins.hyprscrolling ];
