function eve-settings --description "Change to the EVE settings directory"
    if test (uname) = Linux
        ...
        cd "$HOME/Library/Application Support/CCP/EVE/_users_{$USER}_library_application_support_eve_online_sharedcache_tq_eve.app_contents_resources_build_tranquility"
    end
end
