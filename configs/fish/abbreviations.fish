...
set fish_user_abbreviations $fish_user_abbreviations cwd='pwd | trim.newlines | cmd.copy'
...
set fish_user_abbreviations $fish_user_abbreviations pwdc='pwd | trim.newlines | cmd.copy'
...
set fish_user_abbreviations $fish_user_abbreviations ssce='sudo systemctl enable'
set fish_user_abbreviations $fish_user_abbreviations sscen='sudo systemctl enable --now'
set fish_user_abbreviations $fish_user_abbreviations sscd='sudo systemctl disable'
set fish_user_abbreviations $fish_user_abbreviations sscdn='sudo systemctl disable --now'
...
set fish_user_abbreviations $fish_user_abbreviations gcm.='git commit -m "."'
set fish_user_abbreviations $fish_user_abbreviations gcmt='git commit -m "it\'s turtles all the way down"'
...
set fish_user_abbreviations $fish_user_abbreviations gpub='git push -u origin (git.branch)'
...
set fish_user_abbreviations $fish_user_abbreviations grho='git reset --hard origin/(git.branch)'
...
set fish_user_abbreviations $fish_user_abbreviations gsub='git submodule'
