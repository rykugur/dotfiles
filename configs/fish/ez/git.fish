...
abbr --add --global gcof 'git checkout (git branch | fzf | string trim)'
abbr --add --global gcp 'git cherry-pick'
abbr --add --global gcy 'git commit -m (curl -s https://whatthecommit.com/index.txt)'
abbr --add --global gd 'git diff'
abbr --add --global gdstat 'git diff --stat'
abbr --add --global gds 'git diff --staged'
abbr --add --global gf 'git fetch'
abbr --add --global gfp 'git fetch -p'
abbr --add --global gitch 'git fetch'
...
abbr --add --global grpo 'git remote prune origin'
